<template>
    <div class="main">
        ...
        <div class="content">
            <a-spin :spinning="loading" size="large">
                <a-table :data-source="data" :pagination="pagination" rowKey="id" bordered>
                    ...
                    <a-table-column key="price" :sorter="(a, b) => a.price - b.price" title="金额" data-index="price" :width="150" />
        ...
        <a-modal :title="current ? '修改数据' : '新增数据'" :visible="visible" @ok="save" @cancel="visible = false" :confirm-loading="confirmLoading">
            <a-form ref="ruleForm" :model="addForm" :rules="rules" :labelCol="{ span: 4 }" :wrapperCol="{ span: 16 }">
                ...
                <a-form-item label="性质">
                    <a-radio-group name="sigin" default-value="0" v-model:value="addForm.sigin">
                        <a-radio value="0">
                            无
                        </a-radio>
                        <a-radio value="1">
                ...
                <a-form-item name="pay" label="支付方式">
                    <a-radio-group name="pay" default-value="0" v-model:value="addForm.pay">
                        <a-radio value="0">
                            现金
                        </a-radio>
                        <a-radio value="1">
                ...
                <a-form-item name="price" label="金额">
                    <a-input type="number" v-model:value="addForm.price" placeholder="请输金额" class="input" @blur="onBlur" />
                </a-form-item>
                <a-form-item name="desc" label="备注">
                    <a-textarea :maxLength="200" v-model:value="addForm.desc" style="resize:none;width:400px;height:100px" placeholder="备注" class="input" />
                </a-form-item>
            </a-form>
        </a-modal>
    </div>
...
<script lang="ts">
import { saveData, getData, deleteOne } from "@/api/desk";
